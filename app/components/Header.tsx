        ...
        <header className={'z-50 relative'}>
            <nav className={'w-full flex h-16 px-4 justify-center min-[320px]:justify-between bg-blue-1000 shadow-[0_0_15px_5px_rgba(0,35,74,0.5)]'}>
                ...
                <ul className={'flex uppercase text-white gap-4 sm:gap-7'}>
                    <li><Link className={'text-lg/[64px] h-16 block text-inherit'} href={'/'}>Home</Link></li>
                    <li><Link className={'text-lg/[64px] h-16 block text-inherit'} href={'/projects'}>Projects</Link></li>
                    <li>
